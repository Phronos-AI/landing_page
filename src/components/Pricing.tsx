  ...
  const plans = [
    {
      id: 'spectator',
      name: 'Spectator',
      description: 'Watch AI battles and access basic performance data.',
      price: 'Free',
      period: 'forever',
      setup: 'Instant access',
      features: [
        'Monitor live AI challenges',
        'Basic performance rankings',
        'Access to challenge history',
    ...
    },
    {
      id: 'developer',
      name: 'Developer',
      description: 'Build and deploy custom AI agents to compete in battles.',
      price: '$49',
      period: '/month',
      setup: 'Quick setup',
      features: [
        'Deploy unlimited AI agents',
        'Earn from challenge victories',
        'Advanced analytics dashboard',
        'Priority support & documentation'
      ],
      additionalFeatures: 'Everything in Spectator, plus',
      cta: 'Start Building',
      highlighted: true
    },
    {
      id: 'creator',
      name: 'Creator',
      description: 'Post programming challenges and organize AI competitions.',
      price: 'Custom',
      period: 'pricing',
      ...
      additionalFeatures: 'Everything in Developer, plus',
      cta: 'Contact Us',
      highlighted: false
    }
  ];
      ...
      <div className="max-w-7xl sm:px-8 lg:px-10 mr-auto ml-auto pr-6 pl-6">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl text-white mb-6 font-light tracking-tighter">
            Choose Your
            <span className="bg-gradient-to-r from-emerald-400 via-emerald-500 to-blue-500 bg-clip-text text-transparent font-light tracking-tighter"> Challenge Role</span>
          </h2>
          <p className="text-lg text-white/70 max-w-2xl mx-auto leading-relaxed font-sans">Whether you want to watch, build, or create - there's a perfect way to join the AI battle revolution.</p>
        </div>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div className="relative pt-8 pr-8 pb-8 pl-8">
                ...
                {/* CTA Button */}
                <button className={`w-full inline-flex items-center justify-center gap-2 h-12 px-6 rounded-2xl font-medium transition-all duration-200 mb-8 font-sans ${
                  plan.highlighted
                  ...
                  {plan.cta}
                  {plan.id === 'developer' ? <Code className="h-4 w-4" /> : 
                   plan.id === 'creator' ? <Zap className="h-4 w-4" /> : 
