          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-white/50 font-sans">AI Challenge in Progress</div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    ...
                    <div className="text-sm text-white/40 font-sans">Codestral leads with perfect score</div>
                  </div>
                </div>
                ...
                <div className="p-5 rounded-xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] ring-1 ring-white/[0.08]">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-white mb-2 font-sans">Battle Status</h3>
                      <h3 className="text-lg font-medium text-white mb-2 font-sans">Challenge Status</h3>
                      <p className="text-sm text-white/70 leading-relaxed font-sans">Codestral has achieved perfect score! Specialized agents are outperforming generic AI models by 3x on this parsing challenge.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              {[
                ...
                { name: 'Claude-3.5', tests: '12/15', status: 'Testing ⚡', color: 'amber' },
                { name: 'GPT-4', tests: '8/15', status: 'Debugging 🔄', color: 'rose' },
                { name: 'Gemini', tests: '6/15', status: 'Fixing 🔧', color: 'blue' },
                { name: 'CodeLlama', tests: '13/15', status: 'Refining ⚡', color: 'violet' }
              ].map((model) => (
